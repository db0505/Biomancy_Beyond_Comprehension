...
public class ModAnimationsDefinitions {
        ...
        // Malformed flesh blob animations

        public static final AnimationDefinition Malformed_Flesh_Blob_Move_Anim = AnimationDefinition.Builder.withLength(1.0F).looping()
        ...
        public static final AnimationDefinition Malformed_Flesh_Blob_Idle_Anim = AnimationDefinition.Builder.withLength(1.25F).looping()
            .addAnimation("Body", new AnimationChannel(AnimationChannel.Targets.SCALE,
                    new Keyframe(0.0F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
        ...
        // Flesh Dragon animations

        public static final AnimationDefinition Flesh_Dragon_Hovering_Anim = AnimationDefinition.Builder.withLength(1.0833F)
                ...
                .addAnimation("wing_segment_1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -25.0F), AnimationChannel.Interpolations.LINEAR)
                ))
                .addAnimation("wing_segment_2", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                .addAnimation("front_right_foot", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(15.1817F, -0.1634F, 0.9246F), AnimationChannel.Interpolations.LINEAR)
                ))
                ...
                .addAnimation("tail_segment_1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(-22.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
                ))
                .addAnimation("tail_segment_2", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(-15.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
                ))
                ...
                .addAnimation("wing_segment_3", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 25.0F), AnimationChannel.Interpolations.LINEAR)
                ))
                .addAnimation("wing_segment_4", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -15.0F), AnimationChannel.Interpolations.LINEAR)
                ))
        ...
        public static final AnimationDefinition Flesh_Dragon_Ground_Idle_Anim = AnimationDefinition.Builder.withLength(0.0F).looping()
                .addAnimation("wing_segment_1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
                ))
                .addAnimation("Body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
